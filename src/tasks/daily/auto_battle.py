...
def auto_battle(task_instance: "BaseEfTask", config: dict = None) -> bool:
    """
    ...
    use_e_skill = AutoCombatTask.use_e_skill.__get__(task_instance, type(task_instance))
